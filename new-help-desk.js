(function(e) {
		...
		const oe = a,
			...
			le = function(e) {
				...
				function g(e, t, r, o) {
					...
					function u() {
						if (!O.keywords) return void R.addText(I);
						let e = 0;
					...
					function f() {
						...
						if ("string" === typeof O.subLanguage) {
							if (!n[O.subLanguage]) return void R.addText(I);
							e = g(O.subLanguage, I, !0, T[O.subLanguage]), T[O.subLanguage] = e.top
						} else e = w(I, O.subLanguage.length ? O.subLanguage : null);
						O.relevance > 0 && (N += e.relevance), R.addSublanguage(e.emitter, e.language)
					}

					function p() {
						null != O.subLanguage ? f() : u(), I = ""
					}

					function h(e) {
						return e.className && R.openNode(C.classNameAliases[e.className] || e.className), O = Object.create(e, {
							parent: {
								value: O
							}
						}), O
					...
					function b(e) {
						return 0 === O.matcher.regexIndex ? (I += e[0], 1) : (P = !0, 0)
					}
					...
					function _(e) {
						...
						do {
							O.className && R.closeNode(), O.skip || O.subLanguage || (N += O.relevance), O = O.parent
						} while (O !== r.parent);
					...
					function k() {
						const e = [];
						for (let t = O; t !== C; t = t.parent) t.className && e.unshift(t.className);
					...
					function E(t, n) {
						...
						if ("illegal" === n.type && !r) {
							const e = new Error('Illegal lexeme "' + o + '" for mode "' + (O.className || "<unnamed>") + '"');
							throw e.mode = O, e
						}
						if ("end" === n.type) {
							const e = _(n);
					...
					try {
						for (O.matcher.considerAll();;) {
							L++, P ? P = !1 : O.matcher.considerAll(), O.matcher.lastIndex = M;
							const e = O.matcher.exec(a);
							if (!e) break;
							const t = a.substring(M, e.index),
								n = E(t, e);
							M = e.index + n
						}
						return E(a.substr(M)), R.closeAllNodes(), R.finalize(), A = R.toHTML(), {
							relevance: N,
							value: A,
							language: e,
							illegal: !1,
		...
		a("split", (function(e, t, n) {
			...
			return i = "c" == "abbc".split(/(b)*/)[1] || 4 != "test".split(/(?:)/, -1).length || 2 != "ab".split(/(?:ab)*/).length || 4 != ".".split(/(.?)(.?)/).length || ".".split(/()()/).length > 1 || "".split(/.?/).length ? function(e, n) {
				...
				while (k < a.length) {
					m.lastIndex = y ? 0 : k;
					var $, A = v(m, y ? C(a, k) : a);
					if (null === A || ($ = _(f(m.lastIndex + (y ? k : 0)), a.length)) === w) k = d(a, k, h);
					else {
						if (E(S, C(a, w, k)), S.length === b) return S;
						for (var O = 1; O <= A.length - 1; O++)
							if (E(S, A[O]), S.length === b) return S;
						k = w = $
					}
				}
				return E(S, C(a, w)), S
	...
	2266: function(e, t, n) {
		...
		e.exports = function(e, t, n) {
			var r, m, b, w, y, x, _, k = n && n.that,
				...
				O = function(e) {
					return S ? (a(e), C ? $(e[0], e[1], A) : $(e[0], e[1])) : C ? $(e, A) : $(e)
				};
			if (E) r = e;
			else {
	...
	"2b0e": function(e, t, n) {
		...
		(function(e) {
			...
			var O = Function.prototype.bind ? A : $;
			...
			var $e = Object.getOwnPropertyNames(Ee),
				Ae = !0;
			...
			var je = function(e) {
				this.value = e, this.dep = new ge, this.vmCount = 0, W(e, "__ob__", this), Array.isArray(e) ? (Y ? Te(e, Ee) : Re(e, Ee, $e), this.observeArray(e)) : this.walk(e)
			};
			...
			function Ie(e, t) {
				var n;
				if (c(e) && !(e instanceof we)) return y(e, "__ob__") && e.__ob__ instanceof je ? n = e.__ob__ : Ae && !ce() && (Array.isArray(e) || u(e)) && Object.isExtensible(e) && !e._isVue && (n = new je(e)), t && n && n.vmCount++, n
			}
			...
			function ze(e, t) {
				if (!t) return e;
				for (var n, r, o, i = fe ? Reflect.ownKeys(t) : Object.keys(t), a = 0; a < i.length; a++) n = i[a], "__ob__" !== n && (r = e[n], o = t[n], y(e, n) ? r !== o && u(r) && u(o) && ze(r, o) : Me(e, n, o));
				return e
			}
			...
			function Ct(e) {
				return s(e) ? [_e(e)] : Array.isArray(e) ? At(e) : void 0
			}
			...
			function At(e, t) {
				var n, a, c, l, u = [];
				for (n = 0; n < e.length; n++) a = e[n], r(a) || "boolean" === typeof a || (c = u.length - 1, l = u[c], Array.isArray(a) ? a.length > 0 && (a = At(a, (t || "") + "_" + n), $t(a[0]) && $t(l) && (u[c] = _e(l.text + a[0].text), a.shift()), u.push.apply(u, a)) : s(a) ? $t(l) ? u[c] = _e(l.text + a) : "" !== a && u.push(_e(a)) : $t(a) && $t(l) ? u[c] = _e(l.text + a.text) : (i(e._isVList) && o(a.tag) && r(a.key) && o(t) && (a.key = "__vlist" + t + "_" + n + "__"), u.push(a)));
				return u
			}
			...
			function Qt(e) {
				e._o = Wt, e._n = g, e._s = h, e._l = Dt, e._t = zt, e._q = L, e._i = P, e._m = qt, e._f = Ut, e._k = Ft, e._b = Ht, e._v = _e, e._e = xe, e._u = Yt, e._g = Kt, e._d = Xt, e._p = Zt
			}
			...
			var rn = {
					...
					insert: function(e) {
						...
						n._isMounted || (n._isMounted = !0, Un(n, "mounted")), e.data.keepAlive && (t._isMounted ? Jn(n) : Dn(n, !0))
					},
					destroy: function(e) {
			...
			function On(e, t, n) {
				bn = e, xt(t, n || {}, Cn, $n, An, e), bn = void 0
			}
			...
			function Ln(e, t, r, o, i) {
				...
				e.$options._parentListeners = r, On(e, r, g), l && (e.$slots = Rt(i, o.context), e.$forceUpdate())
			}
			...
			function yr(e) {
				e.prototype._init = function(e) {
					var t = this;
					t._uid = wr++, t._isVue = !0, e && e._isComponent ? xr(t, e) : t.$options = Ke(_r(t.constructor), e || {}, t), t._renderProxy = t, t._self = t, In(t), En(t), mn(t), Un(t, "beforeCreate"), jt(t), ar(t), Ot(t), Un(t, "created"), t.$options.el && t.$mount(t.$options.el)
				}
			}
			...
			function $r(e) {
				...
				e.extend = function(e) {
					...
					return a.prototype = Object.create(n.prototype), a.prototype.constructor = a, a.cid = t++, a.options = Ke(n.options, e), a["super"] = n, a.options.props && Ar(a), a.options.computed && Or(a), a.extend = n.extend, a.mixin = n.mixin, a.use = n.use, U.forEach((function(e) {
						a[e] = n[e]
			...
			function Dr(e) {
				...
				})), e.options._base = e, T(e.options.components, Pr), Er(e), Cr(e), $r(e), jr(e)
			}
			...
			var Eo = Object.freeze({
				...
				Co = {
					...
					update: function(e, t) {
						e.data.ref !== t.data.ref && ($o(e, !0), $o(t))
					},
					destroy: function(e) {
						$o(e, !0)
					}
			...
			function Io(e) {
				...
				for (t = 0; t < Oo.length; ++t)
					for (a[Oo[t]] = [], n = 0; n < c.length; ++n) o(c[n][Oo[t]]) && a[Oo[t]].push(c[n][Oo[t]]);
				...
				function g(e, t) {
					o(e.data.pendingInsert) && (t.push.apply(t, e.data.pendingInsert), e.data.pendingInsert = null), e.elm = e.componentInstance.$el, y(e) ? (x(e, t), _(e)) : ($o(e), t.push(e))
				}
				...
				function x(e, n) {
					for (var r = 0; r < a.create.length; ++r) a.create[r](Ao, e);
					t = e.data.hook, o(t) && (o(t.create) && t.create(Ao, e), o(t.insert) && n.push(e))
				}
				...
				function O(e, t, n, s, c, u) {
					if (e !== t) {
						...
						if (i(e.isAsyncPlaceholder)) o(t.asyncFactory.resolved) ? R(e.elm, t, n) : t.isAsyncPlaceholder = !0;
							...
							r(t.text) ? o(h) && o(g) ? h !== g && $(d, h, g, n, u) : o(g) ? (o(e.text) && l.setTextContent(d, ""), k(d, null, g, 0, g.length - 1, n)) : o(h) ? E(h, 0, h.length - 1) : o(e.text) && l.setTextContent(d, "") : e.text !== t.text && l.setTextContent(d, t.text), o(p) && o(f = p.hook) && o(f = f.postpatch) && f(e, t)
						}
					}
				}
				...
				return function(e, t, n, s) {
					if (!r(t)) {
						...
						if (r(e)) c = !0, p(t, d);
							...
							var f = o(e.nodeType);
							if (!f && jo(e, t)) O(e, t, d, null, null, s);
							else {
								if (f) {
									if (1 === e.nodeType && e.hasAttribute(z) && (e.removeAttribute(z), n = !0), i(n) && R(e, t, d)) return j(t, d, !0), e;
									e = u(e)
								}
								var h = e.elm,
									g = l.parentNode(h);
								if (p(t, d, h._leaveCb ? null : g, l.nextSibling(h)), o(t.parent)) {
									...
									while (v) {
										...
										if (v.elm = t.elm, m) {
											for (var w = 0; w < a.create.length; ++w) a.create[w](Ao, v);
			...
			function Do(e, t) {
				...
				if (!e) return o;
				for (n = 0; n < e.length; n++) r = e[n], r.modifiers || (r.modifiers = Po), o[zo(r)] = r, r.def = Ye(t.$options, "directives", r.name, !0);
				return o
			}
			...
			var Ci = x((function(e) {
				...
				Ri = "animation",
				Ii = "animationend";
			$i && (void 0 === window.ontransitionend && void 0 !== window.onwebkittransitionend && (ji = "WebkitTransition", Ti = "webkitTransitionEnd"), void 0 === window.onanimationend && void 0 !== window.onwebkitanimationend && (Ri = "WebkitAnimation", Ii = "webkitAnimationEnd"));
			...
			function Ui(e, t) {
				var n, r = window.getComputedStyle(e),
					...
					u = 0,
					d = 0;
				t === Ai ? a > 0 && (n = Ai, u = a, d = i.length) : t === Oi ? l > 0 && (n = Oi, u = l, d = c.length) : (u = Math.max(a, l), n = u > 0 ? a > l ? Ai : Oi : null, d = n ? n === Ai ? i.length : c.length : 0);
				var f = n === Ai && zi.test(r[ji + "Property"]);
				return {
					type: n,
					timeout: u,
					propCount: d,
					...
					if (!$ || x || "" === x) {
						...
						var L = !1 !== a && !te,
							...
							z = n._enterCb = D((function() {
								L && (Pi(n, j), Pi(n, O)), z.cancelled ? (L && Pi(n, A), N && N(n)) : I && I(n), n._enterCb = null
							}));
						e.data.show || _t(e, "insert", (function() {
							var t = n.parentNode,
								r = t && t._pending && t._pending[e.key];
							r && r.tag === e.tag && r.elm._leaveCb && r.elm._leaveCb(), R && R(n, z)
						})), T && T(n), L && (Li(n, A), Li(n, O), Mi((function() {
							Pi(n, A), z.cancelled || (Li(n, j), P || (Wi(M) ? setTimeout(z, M) : Di(n, s, z)))
						}))), e.data.show && (t && t(), R && R(n, z)), L || P || z()
					}
				}
			}
			...
			function qi(e, t) {
				...
				function k() {
					_.cancelled || (!e.data.show && n.parentNode && ((n.parentNode._pending || (n.parentNode._pending = {}))[e.key] = e), f && f(n), w && (Li(n, l), Li(n, d), Mi((function() {
						Pi(n, l), _.cancelled || (Li(n, u), y || (Wi(x) ? setTimeout(_, x) : Di(n, s, _)))
					}))), p && p(n, _), w || y || _())
				}
			}
			...
			Sr.config.mustUseProp = Br, Sr.config.isReservedTag = ao, Sr.config.isReservedAttr = zr, Sr.config.getTagNamespace = so, Sr.config.isUnknownElement = lo, T(Sr.options.directives, ca), T(Sr.options.components, ka), Sr.prototype.__patch__ = X ? Zi : I, Sr.prototype.$mount = function(e, t) {
	...
	"2b3d": function(e, t, n) {
		...
		var r, o = n("23e7"),
			...
			ae = function(e) {
				...
				while (f()) {
					...
					if (":" != f()) {
						t = n = 0;
						while (n < 4 && I(ee, f())) t = 16 * t + O(f(), 16), d++, n++;
						if ("." == f()) {
							if (0 == n) return;
							if (d -= n, l > 6) return;
							r = 0;
			...
			Ue = function(e, t, n) {
				var r, o, i, a = w(e);
				if (t) {
					if (o = this.parse(a), o) throw A(o);
					this.searchParams = null
				} else {
					if (void 0 !== n && (r = new Ue(n, !0)), o = this.parse(a, null, r), o) throw A(o);
		...
		Ue.prototype = {
			...
			parse: function(e, t, n) {
				var o, i, a, s, c = this,
					...
					h = !1,
					m = !1;
				e = w(e), t || (c.scheme = "", c.username = "", c.password = "", c.host = null, c.port = null, c.path = [], c.query = null, c.fragment = null, c.cannotBeABaseURL = !1, e = D(e, re, "")), e = D(e, oe, ""), o = g(e);
				while (u <= o.length) {
					switch (i = o[u], l) {
						case we:
							if (!i || !I(K, i)) {
						...
						case xe:
							...
							if (n.cannotBeABaseURL && "#" == i) {
								c.scheme = n.scheme, c.path = v(n.path), c.query = n.query, c.fragment = "", c.cannotBeABaseURL = !0, l = ze;
								break
							}
						...
						case Se:
							...
							else if ("?" == i) c.username = n.username, c.password = n.password, c.host = n.host, c.port = n.port, c.path = v(n.path), c.query = "", l = De;
							else {
								if ("#" != i) {
									c.username = n.username, c.password = n.password, c.host = n.host, c.port = n.port, c.path = v(n.path), c.path.length--, l = Le;
									continue
								}
								c.username = n.username, c.password = n.password, c.host = n.host, c.port = n.port, c.path = v(n.path), c.query = n.query, c.fragment = "", l = ze
							}
							break;
						case Ee:
							if (!c.isSpecial() || "/" != i && "\\" != i) {
						...
						case Re:
							if (c.scheme = "file", "/" == i || "\\" == i) l = Ie;
								...
								else if ("?" == i) c.host = n.host, c.path = v(n.path), c.query = "", l = De;
								else {
									if ("#" != i) {
										ve(N(v(o, u), "")) || (c.host = n.host, c.path = v(n.path), c.shortenPath()), l = Le;
										continue
									}
									c.host = n.host, c.path = v(n.path), c.query = n.query, c.fragment = "", l = ze
								}
							}
							break;
						case Ie:
						...
						case Le:
							if (i == r || "/" == i || "\\" == i && c.isSpecial() || !t && ("?" == i || "#" == i)) {
								if (be(d) ? (c.shortenPath(), "/" == i || "\\" == i && c.isSpecial() || P(c.path, "")) : me(d) ? "/" == i || "\\" == i && c.isSpecial() || P(c.path, "") : ("file" == c.scheme && !c.path.length && ge(d) && (c.host && (c.host = ""), d = R(d, 0) + ":"), P(c.path, d)), d = "", "file" == c.scheme && (i == r || "?" == i || "#" == i))
									while (c.path.length > 1 && "" === c.path[0]) z(c.path);
								"?" == i ? (c.query = "", l = De) : "#" == i && (c.fragment = "", l = ze)
							} else d += pe(i, de);
							break;
						case Pe:
							"?" == i ? (c.query = "", l = De) : "#" == i ? (c.fragment = "", l = ze) : i != r && (c.path[0] += pe(i, le));
							break;
						case De:
							t || "#" != i ? i != r && ("'" == i && c.isSpecial() ? c.query += "%27" : c.query += "#" == i ? "%23" : pe(i, le)) : (c.fragment = "", l = ze);
							break;
						case ze:
			...
			setSearch: function(e) {
				e = w(e), "" == e ? this.query = null : ("?" == R(e, 0) && (e = B(e, 1)), this.query = "", this.parse(e, De)), this.searchParams.update()
			},
			...
			setHash: function(e) {
				e = w(e), "" != e ? ("#" == R(e, 0) && (e = B(e, 1)), this.fragment = "", this.parse(e, ze)) : this.fragment = null
			},
			update: function() {
		...
		if (i && u(Fe, {
			...
			var qe = $.createObjectURL,
				We = $.revokeObjectURL;
			qe && d(Be, "createObjectURL", c(qe, $)), We && d(Be, "revokeObjectURL", c(We, $))
		}
		y(Be, "URL"), o({
			global: !0,
			forced: !a,
	...
	"2cf4": function(e, t, n) {
		...
		b && w || (b = function(e) {
			...
			x.now(O(e))
		} : k && !v ? (i = new k, a = i.port2, i.port1.onmessage = j, o = l(a.postMessage, a)) : s.addEventListener && u(s.postMessage) && !s.importScripts && r && "file:" !== r.protocol && !f(T) ? (o = T, s.addEventListener("message", j, !1)) : o = $ in g("script") ? function(e) {
			p.appendChild(g("script"))[$] = function() {
	...
	"466d": function(e, t, n) {
		...
		o("match", (function(e, t, n) {
			return [function(t) {
				...
				while (null !== (f = d(r, o))) {
					var g = s(f[0]);
					p[h] = g, "" === g && (r.lastIndex = u(o, a(r.lastIndex), l)), h++
				}
				return 0 === h ? null : p
			}]
		}))
	...
	"4d63": function(e, t, n) {
				...
				for (var t, n = e.length, r = 0, o = "", i = [], a = {}, s = !1, c = !1, l = 0, u = ""; r <= n; r++) {
					if (t = j(e, r), "\\" === t) t += j(e, ++r);
						...
						case "[" === t:
							...
							break;
						case "(" === t:
							O(N, I(e, r + 1)) && (r += 2, c = !0), o += t, l++;
							continue;
						case ">" === t && c:
							if ("" === u || b(a, u)) throw new $("Invalid capture group name");
		...
		if (a("RegExp", U)) {
			for (var H = function(e, t) {
					...
					if ((h || d(C, e)) && (e = e.source, g && (t = "flags" in m ? m.flags : A(m))), e = void 0 === e ? "" : p(e), t = void 0 === t ? "" : p(t), m = e, _ && "dotAll" in M && (r = !!t && R(t, "s") > -1, r && (t = T(t, /s/g, ""))), n = t, D && "sticky" in M && (o = !!t && R(t, "y") > -1, o && z && (t = T(t, /y/g, ""))), k && (i = F(e), e = i[0], v = i[1]), a = s(E(e, t), u ? this : C, H), (r || o || v.length) && (l = w(a), r && (l.dotAll = !0, l.raw = H(B(e), n)), o && (l.sticky = !0), v.length && (l.groups = v)), e !== m) try {
						c(a, "source", "" === m ? "(?:)" : m)
					} catch (b) {}
					return a
				}, q = function(e) {
		...
		a("replace", (function(e, t, n) {
			...
			return [function(e, n) {
				...
				while (1) {
					...
					if (k($, A), !b) break;
					var O = f(A[0]);
					"" === O && (a.lastIndex = h(s, d(a.lastIndex), w))
				}
				for (var j = "", T = 0, R = 0; R < $.length; R++) {
					A = $[R];
					for (var I = f(A[0]), N = y(x(u(A.index), s.length), 0), M = [], L = 1; L < A.length; L++) k(M, C(A[L]));
					var P = A.groups;
					if (g) {
						var D = _([I], M, N, s);
						void 0 !== P && k(D, P);
						var z = f(r(o, void 0, D))
					} else z = v(I, s, N, M, P, o);
					N >= T && (j += E(s, T, N) + z, T = N + I.length)
				}
				return j + E(s, T)
			}]
		}), !O || !$ || A)
	...
	"56d7": function(e, t, n) {
		"use strict";
		n.r(t);
		n("e260"), n("e6cf"), n("cca6"), n("a79d"), n("fb6a"), n("ac1f"), n("00b4"), n("1276");
		var r = n("2b0e");
		const o = /-(\w)/g,
		...
		var w = b,
			y = function() {
				...
				return n("div", {
					...
					staticClass: "flex backdrop bg-black bg-opacity-10 top-0 left-0 h-screen w-screen fixed z-20 justify-center",
					on: {
						click: function(t) {
					...
					class: {
						"modal mx-auto self-center": "modal" == e.style,
						"mb-20": !e.$widget.config.always_hide_bubble
					},
					style: {
						"z-index": e.$widget.config.z_index || 1e3,
					...
					staticClass: "help-widget-background transition-all duration-200 ease-in-out",
					style: {
					...
					staticClass: "duration-100 ease-in-out",
					style: {
		...
		n("841c"), n("159b"), n("25f0"), n("caad"), n("2532"), n("b0c0"), n("466d"), n("5319");
		...
		const E = e => null !== e && "object" === typeof e,
			...
			A = (...e) => {
				...
				for (const r of e)
					...
					for (let [e, n] of Object.entries(r)) E(n) && e in t && (n = A(t[e], n)), t = {
						...t,
						[e]: n
					};
					E(r.headers) && (n = $(n, r.headers), t.headers = n)
				}
				return t
			},
			O = "function" === typeof globalThis.AbortController,
		...
		const N = {
			...
			D = ["get", "put", "head", "delete", "options", "trace"],
		...
		class W {
			constructor(e, t = {}) {
				...
				if (this._retryCount = 0, this._input = e, this._options = {
						...
						...t,
						headers: $(this._input.headers, t.headers),
						hooks: A({
							beforeRequest: [],
							beforeRetry: [],
							afterResponse: []
				...
				if (O && (this.abortController = new globalThis.AbortController, this._options.signal && this._options.signal.addEventListener("abort", () => {
		...
		var K = G,
			...
			Z = function() {
				var e = this,
					...
					n = e._self._c || t;
				return n("div", {
					staticClass: "p-4 pt-8 flex flex-col",
					style: {
					...
					staticClass: "grid w-full grid-cols-2 gap-8 px-2 mt-10 z-40"
				}, [n("button", {
				...
				})])], 1)]) : e._e(), e._v(" " + e._s(e.$widget.trans("contact")) + " ")]), e.newsArticle ? n("div", {
					staticClass: "col-span-2 row-end-3 text-center"
				}, [e.$widget.trans("news") ? n("h2", {
					staticClass: "px-2 font-semibold tracking-tight mb-2",
					style: {
						color: e.$widget.config.colors.input_label || e.$widget.config.colors.input_text
					}
				}, [e._v(" " + e._s(e.$widget.trans("news")) + " ")]) : e._e(), n("button", {
					key: e.newsArticle.id,
					staticClass: "relative flex flex-col text-left min-h-32 max-h-48 overflow-hidden transition shadow-lg border border-gray-200 duration-200 ease-out transform-gpu hover:-translate-y-px bg-white w-full rounded-lg hover:shadow-xl p-4 focus:ring-2",
					style: {
						background: e.$widget.config.colors.card_background,
					...
					attrs: {
						type: "button",
						"aria-label": e.newsArticle.title
					},
					on: {
						click: function(t) {
							return e.goTo({
				...
				}, [e._v(" " + e._s(e.newsArticle.title) + " ")]), n("h2", {
					staticClass: "text-sm font-medium",
					style: {
						color: e.$widget.config.colors.secondary
					}
				}, [e._v(" " + e._s(e.newsArticle.subtitle) + " ")]), n("p", {
					staticClass: "text-sm font-normal mt-2 break-words overflow-hidden",
					domProps: {
						innerHTML: e._s(e.newsArticle.body)
					}
				}), n("div", {
					staticClass: "absolute left-0 mt-28 h-12 w-full bg-gradient-to-t rounded-b-lg from-white to-transparent"
				})])]) : e._e()]), n("powered-by")], 1)
			},
			Q = [],
			J = function() {
				var e = this,
					t = e.$createElement,
					n = e._self._c || t;
				return e.$widget.config.branding ? n("div", {
					staticClass: "help-widget-footer mt-4 -mb-1 flex w-full flex-grow text-xs justify-center items-end justify-self-end",
					class: ["dark" == e.lightOrDark(e.$widget.config.colors.background) ? "text-white" : "text-gray-600"]
				}, [n("div", [n("a", {
					staticClass: "flex opacity-50 px-3 rounded hover:opacity-75",
					attrs: {
						target: "_blank",
						rel: "noopener",
						href: "https://helpspace.com?referrer=widget"
					}
				}, [n("span", {
					staticStyle: {
						"font-size": "10px"
					}
				}, [e._v("Powered by")]), n("img", {
					staticClass: "h-4 px-1 self-center",
					attrs: {
						src: "dark" == e.lightOrDark(e.$widget.config.colors.background) ? "#",
						alt: "HelpSpace"
					}
				})])])]) : e._e()
			},
			...
			te = {
				name: "PoweredBy",
				methods: {
					lightOrDark: function(e) {
						var t, n, r, o;
						return e.match(/^rgb/) ? (e = e.match(/rgb\((\d+),\s*(\d+),\s*(\d+)\)/), t = e[1], n = e[2], r = e[3]) : (e = +("0x" + e.slice(1).replace(e.length < 5 && /./g, "$&$&")), t = e >> 16, n = e >> 8 & 255, r = 255 & e), o = Math.sqrt(t * t * .299 + n * n * .587 + r * r * .114), o > 127.5 ? "light" : "dark"
					}
				}
			},
			ne = te;
		...
		var oe = re(ne, J, ee, !1, null, null, null, !0),
			ie = oe.exports,
			ae = {
				name: "MainScreen",
				components: {
				...
				mounted: function() {
					this.show = !0, this.$widget.config.news_enabled && this.getNewsArticle()
				},
				methods: {
					goTo: function(e) {
						this.$emit("go-to", e)
					...
					getNewsArticle: function() {
						...
						this.$http.get("articles/news/latest", {
							...
							t.data && (e.newsArticle = t.data)
						}))
					}
				}
			},
			se = ae,
			ce = re(se, Z, Q, !1, null, null, null, !0),
			le = ce.exports,
			ue = function() {
				var e = this,
					t = e.$createElement,
				...
				return n("div", {
					...
					staticClass: "text-2xl text-gray-800 font-extrabold leading-tight tracking-tight",
					style: {
					...
					key: "form",
					staticClass: "w-full -ml-4 z-40 absolute p-4 pt-0",
					attrs: {
				...
				}, [e.showUser || !e.form.name ? n("label", {
					staticClass: "px-1 font-medium opacity-75 text-sm block mb-1 mt-3",
					style: {
						color: e.$widget.config.colors.input_label || e.$widget.config.colors.input_text
					},
					attrs: {
				...
				}, [e._v(e._s(e.$widget.trans("contact_name")))]) : e._e(), e.showUser || !e.form.name ? n("input", {
					directives: [{
						name: "model",
					...
					attrs: {
						type: "text",
						name: "name",
						placeholder: e.$widget.trans("contact_name_placeholder"),
				...
				}, [e._v(" " + e._s(e.errors.name[0]) + " ")]) : e._e(), e.showUser || !e.form.email ? n("label", {
					staticClass: "px-1 font-medium opacity-75 text-sm block mt-3 mb-1",
					style: {
						color: e.$widget.config.colors.input_label || e.$widget.config.colors.input_text
					},
					attrs: {
				...
				}, [e._v(e._s(e.$widget.trans("contact_email")))]) : e._e(), e.showUser || !e.form.email ? n("input", {
					directives: [{
						name: "model",
						rawName: "v-model.trim",
						value: e.form.email,
					...
					attrs: {
						type: "email",
						name: "email",
						placeholder: e.$widget.trans("contact_email_placeholder"),
						disabled: e.isLoading,
						required: ""
					},
					domProps: {
					...
					staticClass: "text-red-600 font-bold text-sm"
				}, [e._v(" " + e._s(e.errors.email[0]) + " ")]) : e._e(), n("label", {
					staticClass: "px-1 font-medium opacity-75 text-sm block mt-3 mb-1",
					style: {
						color: e.$widget.config.colors.input_label || e.$widget.config.colors.input_text
					},
				...
				}, [e._v(e._s(e.$widget.trans("contact_subject")))]), n("input", {
					directives: [{
						name: "model",
						rawName: "v-model.trim",
					...
					attrs: {
						type: "text",
						name: "subject",
						placeholder: e.$widget.trans("contact_subject_placeholder"),
						disabled: e.isLoading,
						required: ""
					},
					domProps: {
					...
					staticClass: "text-red-600 font-bold text-sm"
				}, [e._v(" " + e._s(e.errors.subject[0]) + " ")]) : e._e(), n("label", {
					staticClass: "px-1 font-medium opacity-75 text-sm block mt-3 mb-1",
					style: {
						color: e.$widget.config.colors.input_label || e.$widget.config.colors.input_text
					},
				...
				}, [e._v(e._s(e.$widget.trans("contact_message")))]), n("textarea", {
					directives: [{
						name: "model",
						rawName: "v-model",
						value: e.form.text,
					...
					staticClass: "bg-white text-gray-800 shadow rounded-lg w-full p-2 focus:ring-2 placeholder-current",
					...
					attrs: {
						name: "text",
						rows: e.showUser ? 5 : 10,
						placeholder: e.$widget.trans("contact_message_placeholder"),
						disabled: e.isLoading,
						minlength: "10",
						required: ""
					},
					...
					staticClass: "flex pt-4"
				}, [n("button", {
					staticClass: "transition-all w-full duration-500 ease-in-out rounded-lg ml-auto px-8 py-2 mt-1 shadow text-sm font-bold focus:ring-2 bg-gray-700 hover:bg-gray-600 text-white'",
			...
			fe = (n("b64b"), n("e9c4"), function() {
				...
				return n("div", {
					...
					return n("div", {
						key: r,
						staticClass: "w-full bg-red-50 border-dashed border-2 border-red-300 rounded-lg mt-2 text-red-700 font-medium text-xs p-1 px-2"
					}, [e._v(" " + e._s(t) + " ")])
				}))], 2)
			}),
			pe = [];
		...
		var ye = {
			...
			xe = ye,
			_e = re(xe, fe, pe, !1, null, null, null, !0),
			ke = _e.exports,
			Se = {
				components: {
					FileUploader: ke
			...
			Ee = Se,
			Ce = re(Ee, ue, de, !1, null, null, null, !0),
			$e = Ce.exports,
			Ae = function() {
				var e = this,
					t = e.$createElement,
			...
			Ie = Re,
			Ne = re(Ie, je, Te, !1, null, null, null, !0),
			Me = Ne.exports,
			Le = n("4dd1"),
			Pe = n.n(Le),
			De = n("ee8c"),
			...
			qe = {
				...
				methods: {
					...
					highlightCode: function(e) {
						var t = this;
						return He.a.registerLanguage("php", Be.a), He.a.registerLanguage("javascript", Pe.a), He.a.registerLanguage("css", ze.a), this.$nextTick((function() {
							var e = t.$refs.body.querySelectorAll("code");
							e.forEach((function(e) {
								He.a.highlightBlock(e)
							}))
						})), e
					},
					getArticle: function() {
		...
		var Ge = re(We, Ae, Oe, !1, Ve, null, null, !0),
			Ke = Ge.exports,
			Ye = function() {
				var e = this,
					t = e.$createElement,
				...
				return n("div", {
					...
					return n("button", {
						key: t.id,
						staticClass: "text-left transition shadow duration-500 ease-in-out mb-4 transform-gpu hover:-translate-y-px bg-white w-full rounded-lg hover:shadow-md p-3 focus:ring-2",
						style: {
							background: e.$widget.config.colors.card_background,
							color: e.$widget.config.colors.card_text
						},
						...
						staticClass: "text-sm font-normal mt-1 break-words",
						domProps: {
			...
			Xe = [],
			Ze = (n("2b3d"), n("9861"), n("a15b"), n("4d63"), n("c607"), n("2c3e"), function(e, t) {
				var n;
				return function() {
					var r = this,
						o = arguments;
			...
			Qe = {
				...
				methods: {
					...
					search: Ze((function() {
						var e = this;
						"" != this.query ? this.$http.get("articles/search", {
							prefixUrl: this.$widget.api_url + this.$widget.client_id,
							headers: new Headers({
								Authorization: "Bearer " + this.$widget.token
							}),
		...
		var tt = re(Je, Ye, Xe, !1, et, null, null, !0),
			nt = tt.exports,
			rt = function() {
				var e = this,
					t = e.$createElement,
			...
			at = it,
			st = re(at, rt, ot, !1, null, null, null, !0),
			ct = st.exports,
			lt = {
				components: {
					Main: le,
				...
				methods: {
					getNewsArticle: function() {
						var e = this;
						return this.$http.get("articles/news/latest", {
							prefixUrl: this.$widget.api_url + this.$widget.client_id,
							headers: new Headers({
								Authorization: "Bearer " + this.$widget.token
							}),
							...
							t.data && (e.article = t.data, e.articleId = t.data.id)
						}))
					},
					...
					getSuggestedArticles: function() {
						var e = this;
						this.$http.get("articles/suggested", {
							searchParams: {
					...
					loadConfig: function(e) {
						...
						e && null !== e && void 0 !== e && e.local_config ? this.displayBubble() : K.get(this.$widget.api_url + this.$widget.client_id + "/config/" + this.$widget.widget_id, {
							...
							var n, r, i, a;
							if ((o.errors = t.errors ? t.errors : {}, t) && (o.$widget.config = "object" == _(e) ? X()(t, e) : t, o.setSizes(), null !== (n = o.$widget.config) && void 0 !== n && n.suggested_article_ids && o.setSuggestions(o.$widget.config.suggested_article_ids), null !== (r = o.$widget.config) && void 0 !== r && r.style && (o.style = o.$widget.config.style), o.displayBubble(), null !== (i = o.$widget.config) && void 0 !== i && i.news_enabled && null !== (a = o.$widget.config) && void 0 !== a && a.news_open_after_init)) {
								var s = localStorage.getItem("lastAutoOpen");
								if (s) {
									s = new Date(s);
									var c = new Date,
										l = c - s;
								...
								o.getNewsArticle().then((function() {
									localStorage.setItem("lastAutoOpen", new Date), s > new Date(o.article.publish_date) || (o.openWidget(), o.goTo({
										view: "Article",
										data: {
											id: o.articleId,
											search: ""
					...
					setLanguage: function() {
						this.$widget.language = "auto" === this.$widget.config.language ? navigator.language.slice(0, 2).toLowerCase() : this.$widget.config.language
					},
					setUser: function(e) {
					...
					toggleWidget: function() {
						...
						})), this.suggestedArticles.length || this.$widget.config.disable_docs || this.getSuggestedArticles()
					},
					openWidget: function(e) {
						e && (this.mergeConfig(e), this.forceRerender()), this.suggestedArticles.length || this.$widget.config.disable_docs || this.getSuggestedArticles(), this.isReady ? (this.disableParentScrolling(), this.showWidget = !0) : console.info("Widget could not be opened")
					},
					...
					closeWidget: function() {
						this.resetParentScrolling(), this.showWidget = !1
					},
					...
					lightOrDark: function(e) {
						var t, n, r, o;
						return e.match(/^rgb/) ? (e = e.match(/^rgba?\((\d+),\s*(\d+),\s*(\d+)(?:,\s*(\d+(?:\.\d+)?))?\)$/), t = e[1], n = e[2], r = e[3]) : (e = +("0x" + e.slice(1).replace(e.length < 5 && /./g, "$&$&")), t = e >> 16, n = e >> 8 & 255, r = 255 & e), o = Math.sqrt(t * t * .299 + n * n * .587 + r * r * .114), o > 127.5 ? "light" : "dark"
					}
				}
			},
			ut = lt;
		...
		var ft = re(ut, y, x, !1, dt, null, null, !0),
			pt = ft.exports;
		r["a"].config.productionTip = !1;
		var ht = document.querySelector("#helpspace-widget-script"),
			gt = ht && "tagName" in ht.dataset ? ht.dataset.tagName : "helpspace-widget",
			vt = !(!ht || !("autoInit" in ht.dataset));
		r["a"].prototype.$widget = {
			token: ht && "token" in ht.dataset ? ht.dataset.token : "",
			client_id: ht && "clientId" in ht.dataset ? ht.dataset.clientId : "",
			widget_id: ht && "widgetId" in ht.dataset ? ht.dataset.widgetId : "",
			api_url: "https://widget-api.helpspace.com/api/",
			config: {},
			trans: function(e) {
				var t = navigator.language.slice(0, 2).toLowerCase(),
					n = t in r["a"].prototype.$widget.config.text ? r["a"].prototype.$widget.config.text[t] : r["a"].prototype.$widget.config.text[r["a"].prototype.$widget.config.language];
				return n && e in n ? n[e] : r["a"].prototype.$widget.config.text.en[e]
			}
		...
		}), ht && "token" in ht.dataset && "id" in ht.dataset && (ht.removeAttribute("data-token"), ht.removeAttribute("data-id")), window.HelpWidgetOnMobile = function() {
			var e = !1;
			return function(t) {
			...
			if (t && "tag_name" in t && (gt = t.tag_name), "destroy" != e) {
				if ("init" == e && !document.getElementsByTagName(gt)[0]) {
					"undefined" == typeof window.customElements.get(gt) && window.customElements.define(gt, w(r["a"], pt));
					var n = document.createElement(gt);
			...
			} else document.getElementsByTagName(gt).length && document.getElementsByTagName(gt)[0].remove()
		};
		var mt = function(e) {
			27 === e.keyCode && document.dispatchEvent(new CustomEvent("help_widget_event_close"))
		};
		if (document.addEventListener("keydown", mt), vt) {
			var bt = {};
			bt.suggested_article_ids = ht && "suggestedArticleIds" in ht.dataset ? ht.dataset.suggestedArticleIds.split(",") : null, bt.always_hide_bubble = !(!ht || !("alwaysHideBubble" in ht.dataset)) || null, bt.hide_subject = !(!ht || !("hideSubject" in ht.dataset)) || null, bt.subject_prefill = !(!ht || !("subjectPrefill" in ht.dataset)) || null, bt.text_prefill = !(!ht || !("textPrefill" in ht.dataset)) || null, bt.open_after_init = !(!ht || !("openAfterInit" in ht.dataset)) || null, bt.style = ht && "style" in ht.dataset ? ht.dataset.style : null, bt.z_index = ht && "zIndex" in ht.dataset ? ht.dataset.zIndex : null, bt.offset_top = ht && "offsetTop" in ht.dataset ? ht.dataset.offsetTop : null, bt.offset_left = ht && "offsetLeft" in ht.dataset ? ht.dataset.offsetLeft : null, bt.offset_right = ht && "offsetRight" in ht.dataset ? ht.dataset.offsetRight : null, bt.offset_bottom = ht && "offsetBottom" in ht.dataset ? ht.dataset.offsetBottom : null, bt.position = ht && "position" in ht.dataset ? ht.dataset.position : null, bt.show_logo = !ht || !("showLogo" in ht.dataset) || "true" == ht.dataset.showLogo, window.HelpWidget("init", bt)
		}
	},
	"56ef": function(e, t, n) {
		var r = n("d066"),
					...
					for (u += (w - l) * _, l = w, n = 0; n < e.length; n++) {
						...
						if (r == l) {
							var E = u,
								C = a;
							while (1) {
								var $ = C <= h ? s : C >= h + c ? c : C - h;
								if (E < $) break;
								var T = E - $,
									R = a - $;
								S(t, x(O($ + T % R))), E = y(T / R), C += a
							}
							S(t, x(O(E))), h = j(u, _, m == g), u = 0, m++
						}
					}
					u++, l++
				}
	...
	"7dd0": function(e, t, n) {
		...
		e.exports = function(e, t, n, a, h, v, C) {
			...
			if (L && ($ = l(L.call(new e)), $ !== Object.prototype && $.next && (i || l($) === w || (u ? u($, w) : s($[x]) || p($, x, E)), d($, T, !0, !0), i && (g[T] = E))), m && h == k && N && N.name !== k && (!i && b ? f(I, "name", k) : (R = !0, M = function() {
					return o(N, this)
				})), h)
				if (A = {
						values: j(k),
					...
					for (O in A)(y || R || !(O in I)) && p(I, O, A[O]);
				else r({
					target: t,
					proto: !0,
					forced: y || R
	...
	9263: function(e, t, n) {
		...
		k && (g = function(e) {
			...
			var $ = S.groups,
				...
				T = 0,
				R = E;
			if (A && (O = b(O, "y", ""), -1 === m(O, "g") && (O += "g"), R = w(E, k.lastIndex), k.lastIndex > 0 && (!k.multiline || k.multiline && "\n" !== v(E, k.lastIndex - 1)) && (j = "(?: " + j + ")", R = " " + R, T++), n = new RegExp("^(?:" + j + ")", O)), _ && (n = new RegExp("^" + j + "$(?!\\s)", O)), y && (o = k.lastIndex), s = r(h, A ? n : k, R), A ? s ? (s.input = w(s.input, T), s[0] = w(s[0], T), s.index = k.lastIndex, k.lastIndex += s[0].length) : k.lastIndex = 0 : y && s && (k.lastIndex = k.global ? s.index + s[0].length : o), _ && s && s.length > 1 && r(p, s[0], n, (function() {
					for (c = 1; c < arguments.length - 2; c++) void 0 === arguments[c] && (s[c] = void 0)
				})), s && $)
				for (s.groups = d = l(null), c = 0; c < $.length; c++) f = $[c], d[f[0]] = s[f[1]];
			return s
		}), e.exports = g
	},
	"94ca": function(e, t, n) {
		...
		if (u(ue, {
			...
			var de = s(D.has),
				...
				pe = function(e) {
					if (y(e)) {
						var t, n = e.body;
						if (b(n) === O) return t = e.headers ? new L(e.headers) : new L, de(t, "content-type") || fe(t, "content-type", "application/x-www-form-urlencoded;charset=UTF-8"), _(e, {
							body: k(0, x(n)),
							headers: k(0, t)
						})
					}
	...
	a4d3: function(e, t, n) {
		...
		if (d || (Q = function() {
				...
				return ge(D(e), e)
			})), R.f = we, T.f = ve, j.f = ye, $.f = A.f = xe, O.f = _e, U.f = function(e) {
				return ge(z(e), e)
			}, u && (oe(J, "description", {
				configurable: !0,
				get: function() {
	...
	a9e3: function(e, t, n) {
		...
		if (a(w, !y(" 0o1") || !y("0b1") || y("+0x1"))) {
			for (var $, A = function(e) {
				...
				}, O = r ? h(y) : "MAX_VALUE,MIN_VALUE,NaN,NEGATIVE_INFINITY,POSITIVE_INFINITY,EPSILON,MAX_SAFE_INTEGER,MIN_SAFE_INTEGER,isFinite,isInteger,isNaN,isSafeInteger,parseFloat,parseInt,fromString,range".split(","), j = 0; O.length > j; j++) c(y, $ = O[j]) && !c(A, $) && v(A, $, g(y, $));
			A.prototype = x, x.constructor = A, s(o, w, A)
		}
	},
	aa8e: function(e, t, n) {
		var r = n("24fb");
		...
		var r, o, i, a, s = n("23e7"),
			...
			se = I(z, (function() {
				...
				var n = new q((function(e) {
					...
					o = n.constructor = {};
				return o[D] = r, ae = n.then((function() {})) instanceof r, !ae || !t && M && !Q
			})),
			ce = se || !S((function(e) {
			...
			de = function(e, t, n) {
				...
				Z ? (r = G.createEvent("Event"), r.promise = t, r.reason = n, r.initEvent(e, !1, !0), l.dispatchEvent(r)) : r = {
					promise: t,
					reason: n
				}, !Q && (o = l["on" + e]) ? o(r) : e === J && O("Unhandled promise rejection", n)
			},
			fe = function(e) {
				d(C, l, (function() {
					var t, n = e.facade,
